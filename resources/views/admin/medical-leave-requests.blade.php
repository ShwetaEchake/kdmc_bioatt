                        ...
                        <div class="card">
                            <form class="theme-form" name="addForm" id="addForm">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-3 row">
                                        <input name="page_type" value="{{ request()->page_type }}" type="hidden">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-3 mt-3">
                                            <label class="col-form-label" for="department">Sub Department <span class="text-danger">*</span> </label>
                                        ...
                                        <div class="col-md-3 mt-3">
                                            ...
                                            <input class="form-control" name="designation" type="text" placeholder="Designation" readonly>
                                    ...
                                    <tbody>
                                        @foreach ($leaveRequests as $request)
                                            <tr>
                                                ...
                                                <td> <a href="{{ $request->document->path }}" target="_blank" ></a> </td>
                                                <td>
                ...
                $.ajax({
                    ...
                    success: function(data, textStatus, jqXHR)
                    {
                        if (!data.error2)
                        {
                            ...
                            $("#addForm input[name='department']").val(data.sub_department.name);
                            $("#addForm input[name='designation']").val(data.employee.designation.name);
                        } else {
        ...
        $.ajax({
            ...
            success: function(data, textStatus, jqXHR) {
                ...
                if (!data.error) {
                    ...
                    $("#editForm input[name='ward']").val(data.leave_request.user.employee.ward.name);
                    $("#editForm input[name='department']").val(data.leave_request.user.sub_department.name);
                    $("#editForm input[name='designation']").val(data.leave_request.user.employee.designation.name);
                    ...
                    // {
                        ...
                        $("#editForm input[name='to_date']").attr("min", data.leave_request.from_date);
                    // }
