...
class DepartmentController extends Controller
{
    ...
    public function index()
    {
        ...
        $departments = Department::with('ward')->whereDepartmentId(null)->latest()->get();
    ...
    public function update(UpdateDepartmentRequest $request, Department $department)
    {
        try
        {
            ...
            $input['ward_id'] = $input['edit_ward_id'];
    ...
    {
        $departments = Department::whereWardId($ward->id)->latest()->get();
