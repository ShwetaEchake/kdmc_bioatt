                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-4 mt-3">
                                            ...
                                            <input class="form-control" id="mobile" name="mobile" type="number" placeholder="Enter User Mobile">
                            ...
                            <section class="card">
                                ...
                                <div class="card-body py-2">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-4">
                                            <label class="col-form-label" for="mobile">User Mobile <span class="text-danger">*</span></label>
                                            <input class="form-control" name="mobile" type="number" placeholder="Enter User Mobile">
                                            <span class="text-danger error-text mobile_err"></span>
                                        </div>
...
<script>
    $("#advance-1").on("click", ".change-password", function(e) {
        e.preventDefault();
...
<script>
    $("#advance-1").on("click", ".assign-role", function(e) {
        e.preventDefault();
        var model_id = $(this).attr("data-id");
