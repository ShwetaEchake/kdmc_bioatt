...
class LeaveRepository
{
    ...
    public function storeLeaveRequest($input)
    {
        DB::beginTransaction();
            $user = User::whereEmpCode($input['emp_code'])->first();
    ...
    protected function createLeaveRequestPunch($leave_request, $type)
    {
        ...
        if($type == 'half_day')                      //If leave request is halfday
        {
            Punch::updateOrCreate(
                ...
                [
                    'device_id'=> $leave_request->user->device_id,
            ...
            foreach($dateRanges as $dateRange)
            {
                ...
                Punch::updateOrCreate(
                    ...
                    [
                        ...
                        'check_out'=> Carbon::createFromFormat('Y-m-d H:i:s', $dateRange->toDateString().' '.Carbon::parse($allotedTime)->addHours(9))->toDateTimeString(),
