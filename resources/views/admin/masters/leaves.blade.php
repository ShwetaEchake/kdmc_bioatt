                            ...
                            <form class="theme-form" name="addForm" id="addForm" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-4">
                                            <label class="col-form-label" for="title">Select Leave Type</label>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input class="form-control" id="days" name="days" type="number" placeholder="Enter Leave Days">
                                ...
                                <div class="card-body py-2">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input class="form-control" id="edit_days" name="edit_days" type="number" placeholder="Enter Leave Days">
